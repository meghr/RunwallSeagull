    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex flex-col xs:flex-row gap-4 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                        <Select value={selectedBuilding} onValueChange={onBuildingChange}>
                            <SelectTrigger className="bg-white/5 border-white/10 text-white h-12 sm:h-10">
                ...
                {/* View Mode Toggle */}
                <div className="flex gap-1 p-1 rounded-lg bg-white/5 border border-white/10 w-fit self-end sm:self-auto">
                    <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => onViewModeChange("grid")}
                        className={`px-3 h-10 sm:h-8 ${viewMode === "grid"
                    ...
                    <Button
                        ...
                        className={`px-3 h-10 sm:h-8 ${viewMode === "list"
                            ? "bg-sky-500/20 text-sky-400"
                            : "text-slate-400 hover:text-white"
                            }`}
                    >
            ...
            <form onSubmit={handleSearchSubmit} className="relative">
                ...
                <Input
                    ...
                    className="pl-10 h-12 sm:h-11 bg-white/5 border-white/10 text-white placeholder:text-slate-500 rounded-xl"
                />
            </form>
        </div>
    );
